...
public class PanelMujeres extends JPanel {
	...
	private JTextArea jcorreo, jnombrecompleto, jalias, jestatura, jdivorcios;
	...
	public void inicializarComponentes() {
		...
		jdivorcios = new JTextArea("");
		jdivorcios.setBounds(10, 60, 510, 250);
		jdivorcios.setBorder(new LineBorder(null));
		jdivorcios.setEditable(false);
		add(jdivorcios);
	...
	public JTextArea getJdivorcios() {
		return jdivorcios;
	}

	public void setJdivorcios(JTextArea jdivorcios) {
